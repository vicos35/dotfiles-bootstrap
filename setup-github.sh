...
echo "  • $SSH_KEY_PATH (clé privée)"
echo "  • ${SSH_KEY_PATH}.pub (clé publique)"
echo "  • $SSH_CONFIG (configuration SSH)"
echo "  • $GITCONFIG_LOCAL (identité Git)"
echo ""
echo -e "${CYAN}Prochaines étapes :${RESET}"
echo -e "  1. Cloner votre dépôt :"
echo -e "     ${YELLOW}git clone git@github.com:<username>/dotfiles.git${RESET}"
echo ""
echo -e "  2. Installer les dotfiles :"
